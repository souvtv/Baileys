...
import { addTransactionCapability, aesEncryptCTR, bindWaitForConnectionUpdate, bytesToCrockford, configureSuccessfulPairing, Curve, derivePairingCodeKey, generateLoginNode, generateMdTagPrefix, generateRegistrationNode, getCodeFromWSError, getErrorCodeFromStreamError, getNextPreKeysNode, makeEventBuffer, makeNoiseHandler, promiseTimeout, scheduleMicrotask, signedKeyPair, xmppSignedPreKey, getPlatformId } from '../Utils/index.js';
...
export const makeSocket = (config) => {
    ...
    const sendRawMessage = async (data) => {
        ...
        await promiseTimeout(connectTimeoutMs, async (resolve) => {
            ws.send(bytes);
            resolve();
        });
    };
