...
export declare function getAudioDuration(buffer: Buffer | string | Readable): Promise<undefined>;
/**
  referenced from and modifying https://github.com/wppconnect-team/wa-js/blob/main/src/chat/functions/prepareAudioWaveform.ts
 */
export declare function getAudioWaveform(buffer: Buffer | string | Readable, logger?: ILogger): Promise<undefined>;
...
export declare function generateThumbnail(file: string, mediaType: 'video' | 'image', options: {
    ...
    originalImageDimensions: Record<string, any> | undefined;
}>;
...
export declare const uploadWithFetch: ({ url, filePath, headers, timeoutMs, agent }: UploadParams) => Promise<MediaUploadResult | undefined>;
